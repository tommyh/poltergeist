...
Poltergeist.WebPage = (function() {
  ...
  WebPage.prototype.pushFrame = function(name) {
    ...
    rect = this["native"].evaluate("function () {      var el = document.getElementById('" + name + "') || document.getElementsByName('" + name + "')[0];      if (el != null) {        return el.getBoundingClientRect();      } else {        return {          top: 0,          left: 0        }      }    }");
